...
<input class="form-control" id="email" name="email" type="email" placeholder="sowjanyainfo@gmail.com" required />
<label for="inputEmail">Email address</label>
</div>
 

<div class="form-floating mb-3">
<input class="form-control" id="contact" name="contact" type="text" placeholder="1234566890" required pattern="[0-9]{10}" title="10 numeric characters only"  maxlength="10" required />
